...
router.put('/zone/basic', AuthMiddleware_1.default, ZoneController_1.ZoneController.patchBasicZone);
...
router.get('/user/mails', UserController_1.UserController.getUserWithAddresses);
